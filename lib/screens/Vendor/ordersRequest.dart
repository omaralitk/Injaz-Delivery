...
class OrdersRequest extends StatefulWidget {
  const OrdersRequest({Key? key}) : super(key: key);

  @override
  State<OrdersRequest> createState() => _OrdersRequestState();
}

class _OrdersRequestState extends State<OrdersRequest> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: false,
        title: BigText(color: AppColors.TextColor, text: 'Order in Requests'),
        elevation: 0,
