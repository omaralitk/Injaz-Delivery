// ignore_for_file: unused_import, prefer_const_constructors, duplicate_ignore, avoid_print, avoid_unnecessary_containers
...
class Pinding extends StatefulWidget {
  const Pinding({Key? key}) : super(key: key);

  @override
  State<Pinding> createState() => _PindingState();
}

class _PindingState extends State<Pinding> {
    ...
    return Container(
      ...
      child: Container(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: db
              .collection('Requests')
              .where('Status', isEqualTo: 'Pinding')
              .snapshots(),
